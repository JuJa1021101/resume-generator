...
define(['./workbox-8718427c'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/huggingface\.co\/.*\/resolve\/main\/.*/i, new workbox.CacheFirst({
